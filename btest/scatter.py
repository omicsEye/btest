...
def load_table(args):
    ...
    if args.outfile:
        ...
        viz.scatter_matrix(df_all_rank, x_size = len(row_items),filename ='Scatter_association_' + str(args.association_number) + '_rank.pdf')
        viz.scatter_matrix(df_all, x_size = len(row_items),filename ='Scatter_association_' + str(args.association_number) + '.pdf')
